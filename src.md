...
{% assign filenames = "ccu.c,cstart.c,de.c,font.c,gpio_interrupt.c,hdmi.c,hstimer.c,interrupts.c,mango.c,memmap.ld,ps2_keys.c,rand.c,ringbuffer.c,start.s,uart.c" | split: ',' %}
