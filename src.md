...
{% assign filenames = "cstart.c,de.c,font.c,gpio_interrupt.c,hdmi.c,interrupts.c,interrupts_asm.s,mango.c,ps2_keys.c,rand.c,ringbuffer.c,start.s,uart.c" | split: ',' %}
