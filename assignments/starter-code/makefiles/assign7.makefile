MY_MODULES = timer.o gpio.o strings.o printf.o backtrace.o malloc.o keyboard.o shell.o fb.o gl.o console.o gpio_interrupts.o interrupts_asm.o bits_asm.o
...
# Paths to binaries.
APPLICATION = build/bin/interrupts_console_shell.bin
TEST 		= build/bin/test_keyboard_interrupts.bin
...
LIB_MODULES = $(addprefix build/obj/, $(MY_MODULES))
...
libmypi.a: $(LIB_MODULES) Makefile
	rm -f $@
