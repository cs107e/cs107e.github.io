...
### Inputs
One fun way to extend your Mango Pi is adding support for another input device, such as:
...
Sensors bridge the physical world with the digital. Great resource for learning about sensors "Make: Encyclopedia of Electronic Components Volume 3: Sensors" by Charles Platt and Fredrik Jansson. You can access via Safari Books Online <https://searchworks.stanford.edu/view/13211489> of Stanford library.
...
- Light: RGB leds, led matrix/strip, IR transmitter, laser
- Displays: alphanumeric character display, LCD, OLED, e-paper
- Sound: play music, synthesize sounds
- Vibration: active or passive buzzers, haptic feedback
- Motion: actuator, solenoid, servo, stepper
...
The D1 has a very capable Display Engine peripheral with suppoert for 2-D graphics processing: image compositing, multiple layer overlays, scaling, sprite animation, video mixing, and other nifty features. Available documentation is sparse, so will require some bushwhacking to blaze trails.

### Sound/music

Many past projects have incorporated music and sound, either as an embellishment or primary project component. PWM can be used to generate tones by frequency and other sound effects; I2S gives you a full digital audio both input and output; Midi can be used to can interface with synthesizers and digital instruments.
...
There is a lot of functionality packed within the Mango Pi board that you may want to explore. The industrial-strength protocols (e.g. USB, SHMC, HDMI, MIPI DSI, Ethernet, DMIC, Audio/video codecs) are a major challenge to bring up starting from bare-metal, so not well-suited to final project scope. But  developing a driver for the more starightforward hardware peripherals could be great!
...
#### Wifi/bluetooth
There is a RealTek rtl8723ds wifi and bluetooth module on-board the Mango Pi. Sadly, official documentation is Realtek proprietary/secret and the bootleg info we can find is thin and unhelpful.
