## Lab 3: C functions and the stack
...
1 Use `gdb` to inspect stack frames and find bugs in C programs.

2 Setup your console cable to work with the UART on the Raspberry Pi. 
If you have not switched to the bootloader,
...
1 **Stack frames and back traces**
...
3 **Using the console cable with the Raspberry Pi**

*Make sure your cp2102 drivers are installed and worked properly.*

If you haven't done this, 
follow the instructions in the [Console Guide](../../guides/console.md).
...
If you haven't setup your bootloader,
you should do it now.
Follow the instructions in the
[Bootloader Guide](../../guides/bootloader.md)
If you have problems, seek help.
