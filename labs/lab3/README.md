...
{% comment %} 
Start by filling your Creativity Spot on the [CS107 Wall of Fame](https://piazza.com/class/k2fwoyb4dmni1?cid=82). 
{% endcomment %} 

Before we begin, let's make some conversation and get to know each other. What's a book you've read that you'd recommend? 

Now get some snack and find a buddy. Show off your clock breadboards to each other. Pull up the [check in questions](checkin). You're ready to go!
