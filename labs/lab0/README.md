...
- [ ] Review writeup/code/checkin (instructor)
- [ ] Walk through (TA)
...
Each lab has a sheet of check-in questions to answer as
you go. __Touch base with the staff along the way__ to confirm your
...
$ git pull code-mirror lab0-starter   # pull starter code for this lab
...
> __Pro tip: pay attention to command responses__ As you explore, you may be trying commands copied from our guides or found in a tutorial. Rather than enter a sequence blindly,  consider the intention of each step and what is the expected response. How might you confirm that the command worked correctly? If the command failed or did something wonky, it likely tried to report it to you, but that info may be cryptically phrased or buried in the long-winded chatter. Take it slow and work step-by-step. If you need help interpreting unix-speak, grab a staff member!
{: .callout-warning}
...
If a topic has you curious or confused, start by checking the course website for helpful information. If can't find the information you need, reach out on Ed or come visit us in office hours. We look forward to meeting you and helping with any questions you have! You're ready for this check-in question [^3].

### 6. Binary numbers

Now that you know where the guides are located on the course web site, find the guides to binary numbers and bitmasking.  Read through both guides and then try working through these [bitwise practice problems](https://web.stanford.edu/class/archive/cs/cs107/cs107.1186/lab1/practice.html) courtesy of CS107. A neat practice tool is this [online visualizer for bitwise expressions](https://mdrach.github.io/cs107-apps/) written by CS107 CA Max Drach. If you have any trouble completing these binary/bitwise exercises, ask us for help[^4]
...
## Check in with TA
Be sure to hand in your check-in sheet before leaving lab. We encourage you to touch base with us along the way rather than batching up questions at the end[^5]. Remember that lab is not a race to see who finishes fastest; it's quality time with your CS107E family to work through the material and build understanding.
...
[^3]: Which course guides and resources do you have bookmarked to go back for a deeper read?
[^4]: Any questions about the bitwise practice exercises?
