...
Plug in the usb-serial into a USB port or USB hub on your laptop and confirm it can be found. TODO: command below needs pyserial installed, ugh.
Use `lsusb` to get port on WSL?
