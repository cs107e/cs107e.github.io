...
1. Download our toolchain package file:
    ```console
    $ wget https://github.com/cs107e/homebrew-cs107e/raw/master/DebPackages/gcc-riscv64-unknown-elf_10.2.0-0ubuntu1-107e_amd64.deb
    ```

2. Install the package.

   ```console
   $ sudo apt install -f ./gcc-riscv64-unknown-elf_10.2.0-0ubuntu1-107e_amd64.deb
   ```

{% include checkstep.html content="confirm compiler" %}
{%- comment %}
TODO: update the deb file so apt stops auto reverting to the online package and
update the output of apt list
{%- endcomment %}
```console
