...
{% assign header_names = "assert,backtrace,console,csr,de,fb,font,gl,gpio,gpio_extra,gpio_interrupt,hdmi,hstimer,interrupts,keyboard,malloc,mango,memmap,mouse,printf,ps2,ps2_keys,rand,ringbuffer,shell,shell_commands,strings,symtab,timer,uart" | split: ',' %}
