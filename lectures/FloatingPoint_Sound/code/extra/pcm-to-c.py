...
def main():
    ...
    sample_freq, bits_per_sample, music_data = parse_header(data)
    parse_data(sample_freq, bits_per_sample, music_data)
...
def parse_header(data):
    ...
    print('*/')
    print()
    return sample_freq, bits_per_sample, remaining_data 

def parse_data(sample_freq, bits_per_sample, data):
    data_len = len(data)
    bytes_per_sample = bits_per_sample // 8
    print(f'const int repeat = 0;\n')
    print(f'const int sample_freq = {sample_freq};\n')
    print(f'const int bits_per_sample = {bits_per_sample};\n')
    print(f'const uint{bits_per_sample}_t wav_data[] = {{')
