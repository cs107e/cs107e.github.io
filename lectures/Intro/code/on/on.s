...
# PB config0 register is at offset 0x30 from GPIO base
    ...
    addi    a0,zero,0x30    # add offset
    addi    a1,zero,1       # constant 1 for output
    sw      a1,(a0)         # config PB0 as output
...
# PB data register is at offset 0x40 from GPIO base
    ...
    lui     a0,0x2000       # GPIO base address
    addi    a0,zero,0x40    # add offset
    addi    a1,zero,1       # turn bit on
    sw      a1,(a0)         # turn on PB0
