...
1.A 2N7000 mosfet to discharge the capacitor. Setting DISCHARGE gpio to 1
...
SIGNAL gpio connected to the wiper-resistor node.
The GPIO pin is a comparator,
When the voltage goes above 1.67V, it reads as 1.
