...
| **Week 4 Jan 26** | |
| Lecture 7 (Mon): Serial communication, ASCII and strings ([slides](lectures/Serial/serial.pdf), [code](lectures/Functions/code) | Read about characters and strings, basic IO (getc, putc, puts, printf), and structures (Section 1.5, 1.6, 1.9, 5.5, 6, 7 in K&R; Section 3 in EssentialC). Read about [Serial Communication](https://learn.sparkfun.com/tutorials/serial-communication/all). |
