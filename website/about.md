...
After a wonderful 8-year run on our beloved Raspberry Pi, the end of life of the A+ model necessitated a change in direction. Starting in 2024, we are switching over to __Risc-V__, using the Mango Pi MQ-Pro built on the AllWinner D1 SOC. Adventure awaits!
